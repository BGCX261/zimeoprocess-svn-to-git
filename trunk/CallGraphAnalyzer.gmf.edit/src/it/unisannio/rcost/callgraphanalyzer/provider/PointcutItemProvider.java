...
/**
 * This is the item provider adapter for a {@link it.unisannio.rcost.callgraphanalyzer.Pointcut} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pointcut_scopeModifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pointcut_scopeModifier_feature", "_UI_Pointcut_type"),
				 CallGraphPackage.Literals.POINTCUT__SCOPE_MODIFIER,
				 true,
				 false,
				 false,
