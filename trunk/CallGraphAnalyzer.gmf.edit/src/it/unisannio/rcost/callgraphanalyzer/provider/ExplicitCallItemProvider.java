...
/**
 * This is the item provider adapter for a {@link it.unisannio.rcost.callgraphanalyzer.ExplicitCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExplicitCallItemProvider
	 ...
	 * @generated
	 */
	public ExplicitCallItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExplicitCall"));
	}
	...
	public String getText(Object object) {
		String label = ((ExplicitCall)object).getGroupId();
		return label == null || label.length() == 0 ?
			getString("_UI_ExplicitCall_type") :
			getString("_UI_ExplicitCall_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExplicitCall.class)) {
