...
/**
 * This is the item provider adapter for a {@link it.unisannio.rcost.callgraphanalyzer.NodeLeaf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeLeafItemProvider
	 ...
	 * @generated
	 */
	public NodeLeafItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((NodeLeaf)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NodeLeaf_type") :
			getString("_UI_NodeLeaf_type") + " " + label;
	}
