...
/**
 * This is the item provider adapter for a {@link it.unisannio.rcost.callgraphanalyzer.Dependence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DependenceItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsGetPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Is Get feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsGetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependence_isGet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependence_isGet_feature", "_UI_Dependence_type"),
				 CallGraphPackage.Literals.DEPENDENCE__IS_GET,
				 true,
				 false,
				 false,
	...
	protected void addIsSetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dependence_isSet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dependence_isSet_feature", "_UI_Dependence_type"),
				 CallGraphPackage.Literals.DEPENDENCE__IS_SET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Dependence_type") + " " + dependence.isIsGet();
	}
