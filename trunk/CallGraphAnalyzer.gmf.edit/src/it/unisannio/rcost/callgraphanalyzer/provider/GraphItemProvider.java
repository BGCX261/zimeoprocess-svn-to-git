...
/**
 * This is the item provider adapter for a {@link it.unisannio.rcost.callgraphanalyzer.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFirstLevelGraphPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the First Level Graph feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFirstLevelGraphPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Graph_firstLevelGraph_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Graph_firstLevelGraph_feature", "_UI_Graph_type"),
				 CallGraphPackage.Literals.GRAPH__FIRST_LEVEL_GRAPH,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CallGraphPackage.Literals.GRAPH__NODES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CallGraphPackage.Literals.GRAPH__NODES,
				 CallGraphFactory.eINSTANCE.createPackage()));
		...
		newChildDescriptors.add
			(createChildParameter
				(CallGraphPackage.Literals.GRAPH__NODES,
				 CallGraphFactory.eINSTANCE.createPointcut()));

		newChildDescriptors.add
			(createChildParameter
				(CallGraphPackage.Literals.GRAPH__NODES,
				 CallGraphFactory.eINSTANCE.createAdvice()));
