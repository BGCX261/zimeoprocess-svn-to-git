...
/**
 * This is the item provider adapter for a {@link it.unisannio.rcost.callgraphanalyzer.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CallGraphPackage.Literals.PACKAGE__INNER_MODULES);
			childrenFeatures.add(CallGraphPackage.Literals.PACKAGE__PACKAGES);
		}
	...
	public String getText(Object object) {
		String label = ((it.unisannio.rcost.callgraphanalyzer.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(it.unisannio.rcost.callgraphanalyzer.Package.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CallGraphPackage.Literals.PACKAGE__INNER_MODULES,
		...
		newChildDescriptors.add
			(createChildParameter
				(CallGraphPackage.Literals.PACKAGE__PACKAGES,
