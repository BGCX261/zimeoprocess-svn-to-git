...
public class Package3ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		if (semanticHint == null) {
			semanticHint = CallGraphVisualIDRegistry.getType(Package3EditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				CallGraphVisualIDRegistry.getType(PackageName2EditPart.VISUAL_ID), ViewUtil.APPEND,
				true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				CallGraphVisualIDRegistry.getType(InterfaceBodyCompartment2EditPart.VISUAL_ID),
