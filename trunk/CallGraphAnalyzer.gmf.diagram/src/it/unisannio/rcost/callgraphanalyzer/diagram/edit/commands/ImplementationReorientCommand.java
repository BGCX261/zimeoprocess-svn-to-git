...
//		if (!(getElementToEdit() instanceof Implementation)) {
//			return false;
//		}
...
//		}
	...
	protected boolean canReorientSource() {
		...
		return CallGraphBaseItemSemanticEditPolicy.LinkConstraints
				.canExistImplementation_3006(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Node container = (Node) getLink().eContainer();
		return CallGraphBaseItemSemanticEditPolicy.LinkConstraints
				.canExistImplementation_3006(container, source, getNewTarget());
	}
