...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.InterfaceItemSemanticEditPolicy;
...
public class InterfaceEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InterfaceNameEditPart) {
			((InterfaceNameEditPart) childEditPart).setLabel(getPrimaryShape().InterfaceName());
			return true;
		}
		return false;
	}
