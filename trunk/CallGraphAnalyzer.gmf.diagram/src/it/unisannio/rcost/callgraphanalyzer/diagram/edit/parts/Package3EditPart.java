...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.Package3ItemSemanticEditPolicy;
...
public class Package3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PackageName2EditPart) {
			((PackageName2EditPart) childEditPart).setLabel(getPrimaryShape().PackageName());
			return true;
		}
		return false;
	}
