...
public class CallGraphNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = CallGraphDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		CallGraphAbstractNavigatorItem abstractNavigatorItem = (CallGraphAbstractNavigatorItem) aSelection
				.getFirstElement();
