 ...
 * @generated
 */
public class AspectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	@Override
	 ...
	 * @generated
	 */
	public AspectNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new CallGraphParserProvider.HintAdapter(
					CallGraphElementTypes.Aspect_1002, getParserElement(), parserHint);
