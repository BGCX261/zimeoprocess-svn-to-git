...
//				.canCreateExtension_3004(getContainer(), getSource(),
//						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		// it.unisannio.rcost.callgraphanalyzer.Extension newElement = (it.unisannio.rcost.callgraphanalyzer.Extension) super.doDefaultElementCreation();
		Extension newElement = CallGraphFactory.eINSTANCE.createExtension();
