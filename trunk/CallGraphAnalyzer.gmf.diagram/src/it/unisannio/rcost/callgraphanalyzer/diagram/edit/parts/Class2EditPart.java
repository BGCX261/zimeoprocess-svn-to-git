...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.Class2ItemSemanticEditPolicy;
...
public class Class2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InterfaceName2EditPart) {
			((InterfaceName2EditPart) childEditPart).setLabel(getPrimaryShape().InterfaceName());
			return true;
		}
		return false;
	}
