...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.Package2ItemSemanticEditPolicy;
...
public class Package2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassName3EditPart) {
			((ClassName3EditPart) childEditPart).setLabel(getPrimaryShape().ClassName());
			return true;
		}
		return false;
	}
