 ...
 * @generated
 */
public class AspectName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	@Override
	 ...
	 * @generated
	 */
	public AspectName3EditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return CallGraphElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new CallGraphParserProvider.HintAdapter(
					CallGraphElementTypes.Aspect_2008, getParserElement(), parserHint);
