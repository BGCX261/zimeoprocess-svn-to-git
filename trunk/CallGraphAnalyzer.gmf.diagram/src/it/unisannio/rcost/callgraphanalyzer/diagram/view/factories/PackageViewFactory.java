...
public class PackageViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		if (semanticHint == null) {
			semanticHint = CallGraphVisualIDRegistry.getType(PackageEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				CallGraphVisualIDRegistry.getType(PackageNameEditPart.VISUAL_ID), ViewUtil.APPEND,
				true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				CallGraphVisualIDRegistry.getType(PackageBodyCompartmentEditPart.VISUAL_ID),
