 ...
 * @generated
 */
public class ImplicitCallReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ImplicitCallReorientCommand(ReorientRelationshipRequest request) {
...
//		if (!(getElementToEdit() instanceof ImplicitCall)) {
//			return false;
//		}
...
//		}
	...
	protected boolean canReorientSource() {
		...
		return CallGraphBaseItemSemanticEditPolicy.LinkConstraints
				.canExistImplicitCall_3005(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Node container = (Node) getLink().eContainer();
		return CallGraphBaseItemSemanticEditPolicy.LinkConstraints
				.canExistImplicitCall_3005(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ImplicitCall getLink() {
		return (ImplicitCall) getElementToEdit();
	}
