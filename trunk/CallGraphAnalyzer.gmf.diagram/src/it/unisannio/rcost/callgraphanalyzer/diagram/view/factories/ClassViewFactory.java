...
public class ClassViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		if (semanticHint == null) {
			semanticHint = CallGraphVisualIDRegistry.getType(ClassEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				CallGraphVisualIDRegistry.getType(ClassNameEditPart.VISUAL_ID), ViewUtil.APPEND,
				true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				CallGraphVisualIDRegistry.getType(ClassBodyCompartment3EditPart.VISUAL_ID),
