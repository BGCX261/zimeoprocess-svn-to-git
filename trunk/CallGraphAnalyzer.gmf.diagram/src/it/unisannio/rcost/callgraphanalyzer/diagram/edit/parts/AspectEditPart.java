...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.AspectItemSemanticEditPolicy;
...
public class AspectEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AspectItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AspectNameEditPart) {
			((AspectNameEditPart) childEditPart).setLabel(getPrimaryShape().AspectName());
			return true;
		}
		return false;
	}
