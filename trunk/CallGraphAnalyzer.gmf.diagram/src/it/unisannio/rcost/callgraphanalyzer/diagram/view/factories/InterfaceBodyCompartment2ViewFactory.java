 ...
 * @generated
 */
public class InterfaceBodyCompartment2ViewFactory extends BasicNodeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter,
		...
		if (semanticHint == null) {
			semanticHint = CallGraphVisualIDRegistry
					.getType(InterfaceBodyCompartment2EditPart.VISUAL_ID);
	...
	protected void setupCompartmentTitle(View view) {
		TitleStyle titleStyle = (TitleStyle) view.getStyle(NotationPackage.eINSTANCE
				.getTitleStyle());
		if (titleStyle != null) {
