 ...
 * @generated
 */
public class ExplicitCallReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ExplicitCallReorientCommand(ReorientRelationshipRequest request) {
...
//		if (!(getElementToEdit() instanceof ExplicitCall)) {
//			return false;
//		}
...
//		}
	...
	protected boolean canReorientSource() {
		...
		return CallGraphBaseItemSemanticEditPolicy.LinkConstraints
				.canExistExplicitCall_3001(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Node container = (Node) getLink().eContainer();
		return CallGraphBaseItemSemanticEditPolicy.LinkConstraints
				.canExistExplicitCall_3001(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ExplicitCall getLink() {
		return (ExplicitCall) getElementToEdit();
	}
