...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.ClassItemSemanticEditPolicy;
...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassNameEditPart) {
			((ClassNameEditPart) childEditPart).setLabel(getPrimaryShape().ClassName());
			return true;
		}
		return false;
	}
