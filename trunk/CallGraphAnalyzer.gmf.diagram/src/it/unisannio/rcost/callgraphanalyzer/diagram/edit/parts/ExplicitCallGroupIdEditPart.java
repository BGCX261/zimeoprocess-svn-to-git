 ...
 * @generated
 */
public class ExplicitCallGroupIdEditPart extends LabelEditPart implements ITextAwareEditPart {
	@Override
	...
	static {
		registerSnapBackPosition(
				CallGraphVisualIDRegistry
						.getType(it.unisannio.rcost.callgraphanalyzer.diagram.edit.parts.ExplicitCallGroupIdEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ExplicitCallGroupIdEditPart(View view) {
		super(view);
...
//		super.setVisibility(false);
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof CallGraphTextSelectionEditPolicy) {
			((CallGraphTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new CallGraphParserProvider.HintAdapter(
					CallGraphElementTypes.ExplicitCall_3001, getParserElement(), parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), CallGraphEditPartFactory
