...
import it.unisannio.rcost.callgraphanalyzer.diagram.edit.policies.Interface2ItemSemanticEditPolicy;
...
public class Interface2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassName2EditPart) {
			((ClassName2EditPart) childEditPart).setLabel(getPrimaryShape().ClassName());
			return true;
		}
		return false;
	}
	...
	public class ClassFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrapLabel classFigureType0 = new WrapLabel();
			classFigureType0.setText("<<Class>>");

			classFigureType0.setFont(CLASSFIGURETYPE0_FONT);

			this.add(classFigureType0);

			fClassName = new WrapLabel();
			fClassName.setText("");
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 65, 65, 255);
	 ...
	 * @generated
	 */
	static final Font CLASSFIGURETYPE0_FONT = new Font(Display.getCurrent(), Display.getDefault()
