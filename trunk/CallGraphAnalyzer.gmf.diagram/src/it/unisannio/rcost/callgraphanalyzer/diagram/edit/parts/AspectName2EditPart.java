 ...
 * @generated
 */
public class AspectName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	@Override
	 ...
	 * @generated
	 */
	public AspectName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new CallGraphParserProvider.HintAdapter(
					CallGraphElementTypes.Aspect_2001, getParserElement(), parserHint);
